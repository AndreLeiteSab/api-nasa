"""NeoWs — Near Earth Object Web Service (asteroides)."""
...
async def get_feed(
    ...
    """lista os asteroides próximos da Terra que se aproximam no intervalo de datas informado"""
...
async def browse(
    ...
    """navega pelo conjunto geral de asteroides (paginado)"""
...
async def lookup(
    ...
    """busca um único asteroide pelo SPK-ID do NASA JPL"""
